...
import ru.sberdyshev.learn.geekbrains.java.core.professional.lesson2.homework.dao.jdbc.ProductsJdbcImplDao;
...
public class App {
    public static void main(String[] args) {
        ...
        ProductsDao goodsJdbcCaller = new ProductsJdbcImplDao();
            ...
            if (command.checkWrongArgs()) {
                ...
                switch (command.getType()) {
                    ...
                    case GET_GOODS_IN_A_COST_RANGE: {
                        ...
                        List<Product> products = goodsJdbcCaller.getGoodsWithSpecificPrice(lowestCost, highestCost);
                        for (Product product : products) {
                            System.out.println("Товар: " + product.getTitle() + ". Цена: " + product.getCost() + ".");
                            foundSmth = true;
                            tryCount = 0;
                        }
                        if (!foundSmth) {
